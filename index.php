...
if (isset($_GET['noJS'])) {
    echo "WebInterface need Javascript to work,Turn it on and <a href='/'>retry</a>";
    die();
}
?>
<html>
...
<head>
    <title>WifiPineApple - WebInterface</title>
...
<body onload="init()">
    <div class="statusBar"> 
        <div class="statusBar_widget" >
            ...
            <span class='logout' style="-webkit-filter:invert(1);filter:invert(1);"><a href="/?logout"><img src="/includes/img/exit.png"></a></span>
        </div>
        <span>
